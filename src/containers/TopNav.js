      ...
      <TopNavStyles>
        <nav className='hide-on-mobile' >
          <Menu stackable inverted fixed='top' >
            <Menu.Item as={ Link } to='http://develop.docstack.com/' name='home' />
            <Menu.Item as={ Link } to='' name='blog'>Blog</Menu.Item>
            ...
            <Menu.Menu position='right'>
              ...
              {/*<FollowIcon to='/rss' name='rss' type='application/rss+xml' />*/}
                <Menu.Item as={ Link } to='http://develop.docstack.com/#/login' name='blog'>Login</Menu.Item>
                <Menu.Item as={ Link } to='http://develop.docstack.com/#/signup' name='blog'>Signup</Menu.Item>
            </Menu.Menu>
          </Menu>
        </nav>
        {/*<nav className='show-on-mobile' >*/}
          {/*<Menu inverted >*/}
            ...
            {/*<Menu.Menu position='right'>*/}
              {/*<FollowIcon to='http://develop.docstack.com/#/login' name='twitter' />*/}
              {/*<FollowIcon to='http://www.linkedin.com/in/davideyork' name='linkedin' />*/}
              {/*<FollowIcon to='mailto:david@davideyork.com' name='mail' />*/}
              {/*<FollowIcon to='/rss' name='rss' type='application/rss+xml' />*/}
            {/*</Menu.Menu>*/}
